...
class Backpack_Model(Scene):
    def construct(self):
        ...
        # Analogy
        shed = ImageMobject("shed.png").scale(0.75)
        hammer = ImageMobject("hammer.png").scale(0.25).shift(DOWN*1+LEFT*1.25)
        saw = ImageMobject("saw.png").scale(0.25).next_to(hammer,RIGHT,buff=-1)
        shovel = ImageMobject("shovel.png").scale(0.25).next_to(saw,RIGHT,buff=-1)
        hoe = ImageMobject("hoe.png").scale(0.25).next_to(shovel,RIGHT,buff=-1.25)
